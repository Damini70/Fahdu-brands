...
export default function BrandsEnquiry() {
  ...
  return (
    ...
    <div className={style.brands_p_section}>
      ...
      <div className={style.brands_input_wrapper}>
        <input
      ...
      <div className={`brands_enquiry_file brands_input`} style={{ position: 'relative' }}>
        <div className={`${style.choose_file_block} choose_file_block`}>
          ...
          <div>
            <input
              {...register('brandLogo',{required: true,validate:{ checkFileSize: (value) => {
